...
# app
bot_token = os.environ.get("TOKEN", "6008002657:AAErQz7_XpZgoha7XXC0jh1aq-_sIQInnow") 
api_hash = os.environ.get("HASH", "edb811cb83c768a50060c02f659273e7") 
api_id = os.environ.get("ID", "28559411")
